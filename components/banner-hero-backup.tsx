...
interface BannerHeroProps {
  ...
  parallaxSpeed?: number // Velocidad del parallax (0.1 - 1.0)
  enableParallax?: boolean // Habilitar/deshabilitar parallax
}
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (bannerRef.current) {
        ...
        if (isVisible) {
          // Cálculo simple del parallax basado en la posición del scroll
          const scrolled = window.scrollY
          const elementTop = bannerRef.current.offsetTop
      ...
      {image && (
        <div className="absolute inset-0 scale-110">
          <Image 
            ...
            style={{
              transform: enableParallax ? `translate3d(0, ${scrollY}px, 0)` : 'none'
            }}
            priority
            sizes="100vw"
          />
